...
module.exports = {
  ...
  social: {
    icons: [
      ...
      },
      {
        ...
        title: "发邮件",
        link: "mailto:ab601026460@gmail.com"
      }
    ]
  },
  ...
  footer: {
    ...
    copyrightInfo: [
      ...
      '<p>友情链接：',
      '<a href="https://xugaoyi.com/" target="_blank" style="font-weight:bold">Evan\'s blog（模板）</a>',
      ' | ',
      '<a href="https://github.com/dselegent/dselegent-blog" target="_blank" style="font-weight:bold">dselegent-blog.netlify.app（偏前端）</a>',
      ' | ',
      '<a href="https://xueqimiao.com/" target="_blank" style="font-weight:bold">小薛博客（JAVA）</a>',
      ' | ',
