...
# 启动 Claude Code，自动接受编辑操作
claude --permission-mode acceptEdits

# 启动 Claude Code，跳过所有权限检查（仅限沙盒环境）
...
| **快速入门与配置资料** | [飞书文档](https://ocn0xcqc407f.feishu.cn/wiki/UMEawEPSeii5X3ksbqZcRiGqn2b) |
| **图灵AI大模型资料** | [语雀文档](https://www.yuque.com/aaron-wecc3/dhluml/obvvw1b19ozh67u8?pwd=ghkq) |
| **我见过的讲解AI的最好的视频，没有之一！** | [微信公众号文章（含文字版）](https://mp.weixin.qq.com/s/45q-5Gzz-VlvqkxFI2vdIQ) |
